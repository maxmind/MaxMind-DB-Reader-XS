...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends MaxMind::DB::Reader::XS
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends MaxMind::DB::Reader::XS
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/MaxMind-DB-Reader-XS).
...
can submit an issue report [via the web](https://github.com/maxmind/MaxMind-DB-Reader-XS/issues)
).
...
template file originating in Dist-Zilla-PluginBundle-MAXMIND-0.79.
